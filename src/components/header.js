          ...
          <div className="navigation">
            <nav>
              ...
              <div onClick={handleClick} className="md:hidden">
                {!nav ? (
                  <FiMenu size={30} className="transition-all ease-in duration-300 hover:text-[#fe4039] hover:cursor-pointer" />
                ) : (
                  <FiX size={30} className="transition-all ease-in duration-300 hover:text-[#fe4039] hover:cursor-pointer" />
                )}
                <div
                  className={!nav ? "hidden" : "absolute top-16 left-0 w-full bg-[#1b1b1b] flex flex-col justify-center items-center"}
                >
